...
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Connection Timeout'});
//         case DioExceptionType.sendTimeout:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Send Timeout'});
//         case DioExceptionType.receiveTimeout:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Receive Timeout'});
...
//           } else {
//             return ApiErrorModel(status: error.response?.statusCode, errors: {'message': 'Bad Response'});
//           }
//         case DioExceptionType.badCertificate:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Bad Certificate'});
//         case DioExceptionType.cancel:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Request Cancelled'});
//         case DioExceptionType.connectionError:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Connection Error'});
//         default:
//           return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Unknown Error'});
//       }
//     } else {
//       return ApiErrorModel(status: error.response?.statusCode,errors: {'message': 'Something went wrong'});
//     }
//   }
// }
